...
function applyAdminPageGuidance() {
  ...
  const guidance = {
    ...
    'judges.html': ['Judges', 'Create and verify judge profiles before assigning competitions.', 'Judging'],
    ...
    'schedule-management.html': ['Schedule Management', 'Plan dates, reporting times, stages, durations, and detect schedule conflicts.', 'Judging'],

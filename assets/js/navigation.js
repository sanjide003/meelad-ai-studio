...
function applyAdminPageGuidance() {
  ...
  const guidance = {
    'festival-settings.html': ['Master Setup', 'Configure institution, festival, modes, sections, and categories before registrations.', 'Master Setup'],
    'participating.html': ['Participating', 'Manage admin, team leader, and public registration entry modes.', 'Master Setup'],
    'point-rules.html': ['Scoring Rules', 'Configure grade-only, mark-only, and grade plus mark scoring schemes.', 'Master Setup'],
    'tie-break-rules.html': ['Tie-Break Rules', 'Define tie resolution rules before result publishing.', 'Master Setup'],
    'teams.html': ['Team Management', 'Create teams, chest-number series, leaders, and team mapping before registering students.', 'Team Management'],
    'divisions.html': ['Divisions', 'Advanced setup data; normally managed from Master Setup.', 'Master Setup'],
    'subdivisions.html': ['Subdivisions', 'Advanced setup data; normally managed from Master Setup.', 'Master Setup'],
    'categories.html': ['Categories', 'Advanced setup data; normally managed from Master Setup.', 'Master Setup'],
    'students.html': ['All Students', 'Register, search, and manage student records for the selected festival.', 'Students'],
    'student-create.html': ['Add Students', 'Add students manually or through the approved bulk upload flow.', 'Students'],
    'student-review.html': ['Student Review', 'Review pending student registration data before it becomes official.', 'Students'],
    'competition-rules.html': ['Competition Items', 'Create event items from the approved setup filters and rules.', 'Event Management'],
    'competition-entries.html': ['Competition Entries', 'Register eligible students and teams into competition items.', 'Event Management'],
    'schedule-management.html': ['Schedule Management', 'Plan dates, reporting times, stages, durations, and detect schedule conflicts.', 'Event Management'],
    'account-settings.html': ['My Account', 'Update the primary admin login and copy public portal links safely.', 'People & Access'],
    'users.html': ['Accounts', 'Create and manage administrator, judge, and team leader accounts.', 'People & Access'],
    'user-invitations.html': ['Invitations', 'Legacy invitation page; prefer inline Accounts for judge and team leader access.', 'People & Access'],
    'judges.html': ['Judge Directory', 'Legacy judge directory; account creation is now handled in Accounts.', 'Judging'],
    'judge-assignments.html': ['Judge Assignments', 'Assign verified judges to competitions with entry counts, filters, and schedule warnings.', 'Judging'],
    ...
    'provisional-results.html': ['Provisional Results', 'Review calculated ranks and points before final approval.', 'Results'],
    ...
    'id-cards.html': ['ID Cards', 'Generate printable ID cards after student data is verified.', 'Reports & Certificates'],
    'announcements.html': ['Announcements', 'Publish official updates after checking public visibility.', 'Reports & Certificates'],
    'recalculation.html': ['Recalculation', 'Recalculate rankings carefully after confirming rules and backups.', 'System'],
    'logical-control.html': ['Logical Controls', 'Run diagnostics for duplicate data and rule conflicts.', 'System'],
    'public-data-diagnostics.html': ['Public Data Diagnostics', 'Inspect public-safe data output and publishing readiness.', 'System'],
